...
definitions = {'definitions': {'Identities': {'type': 'object', 'properties': {'items': {'items': {'$ref': '#/definitions/Identity'}, 'type': 'array'}, 'primaryScheme': {'type': 'string'}}}, 'Identity': {'required': ['scheme', 'id'], 'type': 'object', 'properties': {'scheme': {'type': 'string'}, 'legalName': {'type': 'string'}, 'id': {'type': 'string'}, 'uri': {'type': 'string'}}}}, 'parameters': {}}

validators = {
    ('identities_organisations_id_id', 'GET'): {'args': {'required': [], 'properties': {'scheme': {'default': 'GB-COH', 'type': 'string', 'description': 'Name of registry for the identifier'}, 'ocds': {'default': 'false', 'type': 'boolean', 'description': 'return OCDS-compliant response'}}}},
}

filters = {
    ('identities_organisations_id_id', 'GET'): {200: {'headers': None, 'schema': {'items': {'$ref': '#/definitions/Identities'}, 'type': 'array'}}, 404: {'headers': None, 'schema': None}},
}
